...
const visionMission: VisionMissionItem[] = [
  {
    ...
    title: "Our Mission",
    description:
      "To design and execute data-driven digital marketing strategies that solve real business problems. We deliver high-performing campaigns, memorable brand identities, and AI-powered automations to help businesses scale globally."
  },
  {
    type: "vision",
    title: "Our Vision",
    description:
      "To become a globally trusted marketing partner that transforms brands into market leaders, empowering businesses worldwide through innovative strategies, creative excellence, and measurable results."
  }
];
