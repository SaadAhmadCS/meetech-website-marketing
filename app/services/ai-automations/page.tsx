...
const deliverables = [
  ...
  "CRM workflows and marketing pipeline automations",
  "AI-powered content and response assistance",
  "Custom process automation to reduce manual ops",
];
...
export default function ServicePage() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-24 text-text-primary">
      ...
      <h1 className="mb-6 text-4xl font-black md:text-5xl">AI Automations</h1>
      <p className="mb-10 max-w-3xl text-lg leading-relaxed text-text-body">
        We automate repetitive marketing and sales tasks so your team can focus
        on strategy, creativity, and growth.
      </p>
