...
const deliverables = [
  ...
  "Color, typography, and visual identity kit",
  "Brand assets for web, social, and ad creatives",
];
...
export default function ServicePage() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-24 text-text-primary">
      ...
      <h1 className="mb-6 text-4xl font-black md:text-5xl">Branding + Logo</h1>
      <p className="mb-10 max-w-3xl text-lg leading-relaxed text-text-body">
        We build a memorable brand identity that communicates trust, clarity,
        and ambition across every touchpoint.
      </p>
