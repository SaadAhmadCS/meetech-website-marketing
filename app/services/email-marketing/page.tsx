...
const deliverables = [
  "Lifecycle email strategy and segmentation",
  "Automated sequences for onboarding and retention",
  "Campaign copywriting and conversion-focused design",
...
export default function ServicePage() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-24 text-text-primary">
      ...
      <h1 className="mb-6 text-4xl font-black md:text-5xl">Email Marketing</h1>
      <p className="mb-10 max-w-3xl text-lg leading-relaxed text-text-body">
        We create high-performing email systems that nurture leads, increase
        repeat purchases, and maximize customer lifetime value.
      </p>
