...
const categories = [
     { id: 'Campaigns', icon: <TrendingUp size={14} /> },
     { id: 'Branding', icon: <Briefcase size={14} /> },
     { id: 'Automations', icon: <Monitor size={14} /> },
] as const;
...
export default function PortfolioPage() {
     const [selectedCategory, setSelectedCategory] = useState<CategoryId>('Campaigns');
     ...
     return (
          <div className="relative z-20 h-[420vh] md:h-full w-full text-text-primary selection:bg-accent selection:text-text-inverse font-sans transition-colors duration-500 py-5 md:py-0">
               ...
               >
                    ...
                    >
                         Hand-picked case studies showcasing strategic marketing, high-converting branding, and automated growth for real businesses.
                    </motion.p>
                    ...
                    >
                         {[
                              { label: "Campaigns", val: "80+" },
                              { label: "Brands Built", val: "40+" },
                              { label: "Automations", val: "30+" },
